...
#[doc = "Constants used in FreeImage_ColorQuantize."]
pub type FREE_IMAGE_QUANTIZE = u32;
...
#[doc = "Constants used in FreeImage_Dither."]
pub type FREE_IMAGE_DITHER = u32;

pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_NONE: FREE_IMAGE_JPEG_OPERATION = 0;
#[doc = "! no transformation"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_FLIP_H: FREE_IMAGE_JPEG_OPERATION = 1;
#[doc = "! horizontal flip"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_FLIP_V: FREE_IMAGE_JPEG_OPERATION = 2;
#[doc = "! vertical flip"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_TRANSPOSE: FREE_IMAGE_JPEG_OPERATION = 3;
#[doc = "! transpose across UL-to-LR axis"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_TRANSVERSE: FREE_IMAGE_JPEG_OPERATION = 4;
#[doc = "! transpose across UR-to-LL axis"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_ROTATE_90: FREE_IMAGE_JPEG_OPERATION = 5;
#[doc = "! 90-degree clockwise rotation"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_ROTATE_180: FREE_IMAGE_JPEG_OPERATION = 6;
#[doc = "! 180-degree rotation"]
pub const FREE_IMAGE_JPEG_OPERATION_FIJPEG_OP_ROTATE_270: FREE_IMAGE_JPEG_OPERATION = 7;
#[doc = " Lossless JPEG transformations"]
#[doc = "Constants used in FreeImage_JPEGTransform"]
pub type FREE_IMAGE_JPEG_OPERATION = u32;
...
#[doc = "Constants used in FreeImage_ToneMapping."]
pub type FREE_IMAGE_TMO = u32;
...
#[doc = "Constants used in FreeImage_Rescale."]
pub type FREE_IMAGE_FILTER = u32;
...
#[doc = " Color channels."]
#[doc = "Constants used in color manipulation routines."]
pub type FREE_IMAGE_COLOR_CHANNEL = u32;
...
#[doc = "Tag data type information (based on TIFF specifications)"]
#[doc = ""]
#[doc = "Note: RATIONALs are the ratio of two 32-bit integer values."]
pub type FREE_IMAGE_MDTYPE = u32;
...
#[doc = "Metadata models supported by FreeImage"]
pub type FREE_IMAGE_MDMODEL = i32;
...
extern "C" {
	pub fn FreeImage_JPEGTransform(
		src_file: *const ::std::os::raw::c_char,
		dst_file: *const ::std::os::raw::c_char,
		operation: FREE_IMAGE_JPEG_OPERATION,
		perfect: BOOL,
	) -> BOOL;
}
extern "C" {
	pub fn FreeImage_JPEGTransformU(
		src_file: *const wchar_t,
		dst_file: *const wchar_t,
		operation: FREE_IMAGE_JPEG_OPERATION,
		perfect: BOOL,
	) -> BOOL;
}
extern "C" {
	pub fn FreeImage_JPEGCrop(
		src_file: *const ::std::os::raw::c_char,
		dst_file: *const ::std::os::raw::c_char,
...
extern "C" {
	pub fn FreeImage_JPEGTransformFromHandle(
		src_io: *mut FreeImageIO,
		src_handle: fi_handle,
		dst_io: *mut FreeImageIO,
		dst_handle: fi_handle,
		operation: FREE_IMAGE_JPEG_OPERATION,
...
extern "C" {
	pub fn FreeImage_JPEGTransformCombined(
		src_file: *const ::std::os::raw::c_char,
		dst_file: *const ::std::os::raw::c_char,
		operation: FREE_IMAGE_JPEG_OPERATION,
		left: *mut ::std::os::raw::c_int,
...
extern "C" {
	pub fn FreeImage_JPEGTransformCombinedU(
		src_file: *const wchar_t,
		dst_file: *const wchar_t,
		operation: FREE_IMAGE_JPEG_OPERATION,
		left: *mut ::std::os::raw::c_int,
...
extern "C" {
	pub fn FreeImage_JPEGTransformCombinedFromMemory(
		src_stream: *mut FIMEMORY,
		dst_stream: *mut FIMEMORY,
		operation: FREE_IMAGE_JPEG_OPERATION,
		left: *mut ::std::os::raw::c_int,
		top: *mut ::std::os::raw::c_int,
		right: *mut ::std::os::raw::c_int,
